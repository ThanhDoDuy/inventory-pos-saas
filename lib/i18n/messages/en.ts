...
export const en: Messages = {
  ...
  nav: {
    ...
    item: {
      ...
      taxReportS1a: 'Revenue Ledger S1a-HKD',
    },
    empty: {
  ...
  reports: {
    ...
    taxS1aHkd: {
      title: 'Revenue Ledger S1a-HKD',
      subtitle: 'Detailed revenue record for goods/services sales',
      year: 'Year',
      exportExcel: 'Export Excel',
      exporting: 'Exporting...',
      loading: 'Loading report data...',
      noData: 'No paid invoices found for this year',
      table: {
        date: 'Date',
      ...
      total: 'Total',
      configMissing: 'Tax report settings are not configured. Go to Settings → Tax Report to fill in your business information.',
  ...
  settings: {
    ...
    taxReport: {
      title: 'Tax Report Configuration (S1a-HKD)',
      subtitle: 'Information printed on the revenue ledger for individual/household businesses',
      businessName: 'Business name (HKD/individual)',
      taxCode: 'Tax code (MST)',
      businessLocation: 'Business location',
      group1Label: 'Revenue group 1 label',
      group1Types: 'Customer types for group 1 (comma-separated)',
      group2Label: 'Revenue group 2 label',
      group2Types: 'Customer types for group 2 (comma-separated)',
      saved: 'Tax report settings saved',
      error: 'Could not save tax report settings',
      saving: 'Saving...',
      hint: 'Valid types: COMPANY, GROUP, INDIVIDUAL, NONE (NONE = walk-in with no linked customer)',
    },
    priceTiers: {
      title: 'Price tiers',
