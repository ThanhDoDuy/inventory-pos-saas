...
export const vi: Messages = {
  ...
  nav: {
    ...
    item: {
      ...
      taxReportS1a: 'Sổ Doanh Thu S1a-HKD',
    },
    empty: {
  ...
  reports: {
    ...
    taxS1aHkd: {
      title: 'Sổ Chi Tiết Doanh Thu Bán Hàng Hóa, Dịch Vụ (S1a-HKD)',
      subtitle: 'Sổ chi tiết doanh thu hàng hóa, dịch vụ',
      year: 'Năm',
      exportExcel: 'Xuất Excel',
      exporting: 'Đang xuất...',
      loading: 'Đang tải dữ liệu báo cáo...',
      noData: 'Không có hóa đơn đã thanh toán trong năm này',
      table: {
        date: 'Ngày tháng',
        transaction: 'Giao dịch',
        amount: 'Số tiền',
        invoiceCount: '({count} HĐ)',
      },
      total: 'Tổng cộng',
      configMissing: 'Chưa cấu hình thông tin khai thuế. Vào Cài đặt → Khai thuế để điền thông tin.',
  ...
  rbac: {
    ...
    customPanel: {
      ...
      subtitle: 'Tạo và quản lý vai trò riêng cho cửa hàng của bạn',
      createRole: 'Tạo vai trò',
      empty: 'Chưa có vai trò tùy chỉnh. Bấm "Tạo vai trò" để thêm mới.',
      createFirst: 'Tạo vai trò đầu tiên',
      table: {
        role: 'Vai trò',
        description: 'Mô tả',
      ...
      modal: {
        ...
        editSubtitle: 'Cập nhật tên, mô tả và quyền của vai trò tùy chỉnh',
        createSubtitle: 'Mã vai trò không thể đổi sau khi tạo',
      },
      form: {
        code: 'Mã vai trò',
        codeHint: 'Viết HOA, ví dụ: WAREHOUSE_LEAD',
        codePlaceholder: 'WAREHOUSE_LEAD',
        displayName: 'Tên hiển thị',
        displayNamePlaceholder: 'Trưởng kho',
        description: 'Mô tả',
        descriptionPlaceholder: 'Mô tả ngắn về vai trò...',
        permissions: 'Quyền',
        permissionsSelected: '({count} đã chọn)',
        searchPermissions: 'Tìm quyền...',
        noPermissions: 'Không tìm thấy quyền phù hợp',
        selectAll: 'Chọn tất cả',
        deselectAll: 'Bỏ chọn',
      },
      validation: {
        codeRequired: 'Vui lòng nhập mã vai trò',
        codeFormat: 'Mã vai trò phải viết HOA, bắt đầu bằng chữ cái (ví dụ: WAREHOUSE_LEAD)',
        codeReserved: 'Mã ADMIN, MANAGER, STAFF là vai trò hệ thống — không dùng được',
        nameRequired: 'Vui lòng nhập tên vai trò',
        permissionsRequired: 'Chọn ít nhất một quyền',
      },
      confirm: {
        delete: 'Xóa vai trò "{name}" ({code})? Hành động này không thể hoàn tác.',
      },
      error: {
        actionFailed: 'Thao tác thất bại',
  ...
  settings: {
    ...
    error: {
      ...
      featureFlagFailed: 'Không thể cập nhật tính năng',
    },
    tabs: {
      business: 'Cửa hàng',
      billing: 'Thanh toán',
    ...
    taxReport: {
      title: 'Cấu hình khai thuế (Mẫu S1a-HKD)',
      subtitle: 'Thông tin in trên sổ doanh thu dành cho hộ/cá nhân kinh doanh',
      businessName: 'Tên hộ/cá nhân kinh doanh',
      taxCode: 'Mã số thuế (MST)',
      businessLocation: 'Địa điểm kinh doanh',
      group1Label: 'Tên nhóm doanh thu 1',
      group1Types: 'Loại khách hàng nhóm 1 (cách nhau bằng dấu phẩy)',
      group2Label: 'Tên nhóm doanh thu 2',
      group2Types: 'Loại khách hàng nhóm 2 (cách nhau bằng dấu phẩy)',
      saved: 'Đã lưu cấu hình khai thuế',
      error: 'Không thể lưu cấu hình khai thuế',
      saving: 'Đang lưu...',
      hint: 'Giá trị hợp lệ: COMPANY, GROUP, INDIVIDUAL, NONE (NONE = khách vãng lai không có hồ sơ)',
    },
    priceTiers: {
      title: 'Loại giá bán',
  ...
  importExport: {
    ...
    menu: 'Nhập / Xuất',
    error: {
      exportFailed: 'Không thể xuất file Excel',
      ...
      importSuppliersFailed: 'Không thể import nhà cung cấp',
      importCustomersFailed: 'Không thể import khách hàng',
      importPurchaseOrdersFailed: 'Không thể import đơn mua hàng',
  ...
  receipt: {
    defaultStoreName: 'Cửa hàng',
    invoiceTitle: 'HÓA ĐƠN BÁN HÀNG',
    documentTitle: 'Hóa đơn {number}',
    phonePrefix: 'ĐT:',
    ...
    unnamedProduct: 'Sản phẩm',
    printInitFailed: 'Không thể khởi tạo bản in',
    paymentMethods: {
      CASH: 'Tiền mặt',
